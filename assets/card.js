...
function setData(id, value){
  ...
  var holder = titleEl.closest(".data_holder") || titleEl.closest(".field") || titleEl.parentElement;
  if (!holder) return;

  var valueEl = holder.querySelector(".data_value") || holder.querySelector("strong") || holder.querySelector("b");
  if (!valueEl) return;

  // POPRAWKA: Jeśli "value" jest puste, nie rób nic (zachowaj to, co w HTML)
  if (value && value !== "" && value !== "undefined" && value !== "ul. undefined<br>undefined undefined") {
